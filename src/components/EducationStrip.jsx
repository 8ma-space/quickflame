      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h2 className="text-3xl font-black text-white">{t('education.title')}</h2>
          </div>
        ...
        <div ref={ref} className="flex gap-5 overflow-x-auto hide-scroll pb-2">
          {EDUCATION.map((card, i) => (
            ...
            >
              ...
              <div>
                <div className="text-xs font-bold text-white/50 uppercase tracking-wide mb-2">{t('education.sources')}</div>
